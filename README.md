...
<a href="#contributors">팀원 소개</a> •
<a href="#schedule">프로젝트 일정</a> •
<a href="#system-architecture">시스템 구성도</a> •
...
# 1. 프로젝트 소개
Grids & Circles는 작은 로컬 카페에서 운영하는 온라인 커피 원두 패키지 주문 서비스입니다.

고객은 웹사이트를 통해 손쉽게 원하는 원두 패키지를 주문할 수 있으며, 매일 전날 오후 2시부터 당일 오후 2시까지 접수된 주문을 모아 일괄 처리합니다.

현재 제공되는 상품은 총 4종류의 원두 패키지로, 다양한 취향에 맞게 선택할 수 있습니다.
...
# 3. 프로젝트 일정 
<img alt="일정" src="https://github.com/user-attachments/assets/6d3948e0-ae03-4627-9367-dfbb4578da72" width="600"/>

<div id="system-architecture">
  
# 4. 시스템 구성도
<img width="600" height="396" alt="image" src="https://github.com/user-attachments/assets/73b8630e-3de2-4436-8485-740d68a2685e" />

<div id="erd">
  
# 5. ERD 다이어그램
<img width="600" height="396" alt="image" src="https://github.com/user-attachments/assets/11ce4748-fb46-4fa2-8193-1696e9eee58b" />
...
<img src="https://img.shields.io/badge/H2%20Database-003B57?style=for-the-badge&logo=h2&logoColor=white">
